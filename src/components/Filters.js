  ...
  return (
    <div className="price-range__slider">
      <Slider
        ...
        classNames={{
          filler: "bg-primary-color",
        }}
        renderThumb={(props) => (
          <div
            {...props}
            className="bg-primary-color group p-1 top-1/2 shadow-medium rounded-full cursor-grab data-[dragging=true]:cursor-grabbing"
          >
